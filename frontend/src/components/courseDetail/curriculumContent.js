...
import { getTypeColor, getTypeIcon } from "../../utils/helper";
      ...
      <div className="curriculum-header">
        ...
        <div className="curriculum-stats">
          <span className="stat-item">
            <strong>6 sections</strong> • <strong>89 lectures</strong> •{" "}
            <strong>40h 15m</strong> total length
          </span>
        </div>
      </div>
                  ...
                  <div key={lectureIndex} className="lecture-item">
                    <div className="lecture-info">
                      <div className="lecture-icon-wrapper">
                        <span
                          className={`lecture-icon ${getTypeColor(
                            lecture.type
                          )}`}
                        >
